...
Dim dsta(2), dxp(2), dyp(2), dvy(2), dvx(2), dstt(2), dwep(2), dwes(2, 5), dmload(2, 10), dmnum(2), dhp(2), datkpianyi(2) As Integer '机器人状态
'12.26



Private Sub Command1_Click()
If MsgBox("要开启生存模式吗？", vbYesNo) = vbYes Then hp(1) = 1: hp(2) = 1: Exit Sub
